        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-6 right-box">
                ...
                <form class="row align-items-center" action="{{ route('password.update') }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="password" class="form-control form-control-lg bg-light fs-6" placeholder="Mật khẩu mới" required />
                    </div>

                    <div class="input-group mb-3">
                        <input type="password" name="password_confirmation" class="form-control form-control-lg bg-light fs-6" placeholder="Xác nhận mật khẩu mới" required />
                    </div>
